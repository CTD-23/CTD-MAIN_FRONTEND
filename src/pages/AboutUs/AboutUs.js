  ...
  return (
    <div>
      ...
      <div class="container text-center mt-lg-5 p-5 mt-sm-0 text-white">
        ...
        <div class="row my-5 py-3 py-sm-1">
          <div class="col d-flex justify-content-center col-12 col-lg-6 mb-sm-5 mb-3">
            <img class="img-fluid" src="https://ctd.pictieee.in/static/media/ieee.afc7672e5bd9b388828d.png" alt="" style={{"max-width" : "50%" }} />
          </div>

          <div class="col col-12 col-lg-6 content">
            <h2 class="text-center">Institute of Electrical and Electronics Engineering</h2>
        ...
        <div class="row d-flex flex-row-reverse my-5 py-3">

          <div class="col d-flex justify-content-center col-12 col-lg-6">
            <img class="img-fluid" src="https://ctd.pictieee.in/static/media/credenz.027d8cf4726375a177d8.jpg" alt="" style={{"max-width": "65%", "max-height": "85%"}} />
          </div>

          <div class="col col-12 col-lg-6 content">
            <h2 class="text-center">PICT IEEE Student Branch (PISB)</h2>
        ...
        <div class="row my-5 py-3">
          ...
          <div class="col d-flex justify-content-center col-12 col-lg-6">
            <img class="img-fluid" src="https://ctd.pictieee.in/static/media/ping.94d36c92d02619928114.jpg" alt="" style={{"max-width": "50%", "max-height": "85%"}} />
          </div>

          <div class="col col-12 col-lg-6 content">
            <h2 class="text-center">PICT IEEE NEWSLETTER GROUP (P.I.N.G.)</h2>
